...
>> load 'hcluster.rb'
=> true
>> cluster = AWS::EC2::Base::HCluster.new({:hbase_version => '0.20.5',:security_group_prefix => 'hdfs'})
=> #<AWS::EC2::Base::HCluster:0x102a9f9b8 @rs_key_name="root", @slave_image_={"name"=>"hbase-0.20.5-x86_64", 
   ...
>> cluster.launch
[launch:zk.........................]
...
pre.
>> AWS::EC2::Base::HCluster.create_image({:hbase_version => '0.21.0-SNAPSHOT'})
...
image registered.
shutting down image-builder i-29f90743
=> "ami-ee40a887"
